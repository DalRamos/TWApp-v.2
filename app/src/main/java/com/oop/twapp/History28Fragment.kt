...
class History28Fragment : Fragment() {

    private lateinit var binding: FragmentHistory28Binding
    ...
    override fun onCreateView(
        ...
        binding = FragmentHistory28Binding.inflate(inflater, container, false)
