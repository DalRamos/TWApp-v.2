...
class History26Fragment : Fragment() {

    private lateinit var binding: FragmentHistory26Binding
    ...
    override fun onCreateView(
        ...
        binding = FragmentHistory26Binding.inflate(inflater, container, false)
