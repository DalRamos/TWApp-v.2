...
class History27Fragment : Fragment() {

    private lateinit var binding: FragmentHistory27Binding
    ...
    override fun onCreateView(
        ...
        binding = FragmentHistory27Binding.inflate(inflater, container, false)
