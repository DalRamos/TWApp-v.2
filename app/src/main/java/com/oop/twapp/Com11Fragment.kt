...
import com.oop.twapp.databinding.FragmentCom11Binding

class Com11Fragment : Fragment() {

    private lateinit var binding: FragmentCom11Binding
   ...
   override fun onCreateView(
        ...
        binding = FragmentCom11Binding.inflate(layoutInflater, container, false)
