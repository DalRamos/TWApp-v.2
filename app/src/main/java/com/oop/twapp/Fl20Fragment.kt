...
import com.oop.twapp.databinding.FragmentFl20Binding


class Fl20Fragment : Fragment() {

    private lateinit var binding: FragmentFl20Binding
    ...
    override fun onCreateView(
        ...
        binding = FragmentFl20Binding.inflate(inflater, container, false)
