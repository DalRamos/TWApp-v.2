...
import com.oop.twapp.databinding.FragmentCom15Binding

class Com15Fragment : Fragment() {

    private lateinit var binding: FragmentCom15Binding
    ...
    override fun onCreateView(
       ...
       binding = FragmentCom15Binding.inflate(layoutInflater, container, false)
