...
import com.oop.twapp.databinding.FragmentFl24Binding


class Fl24Fragment : Fragment() {

    private lateinit var binding: FragmentFl24Binding
    ...
    override fun onCreateView(
        ...
        binding = FragmentFl24Binding.inflate(inflater, container, false)
