...
import com.oop.twapp.databinding.FragmentCom9Binding

class Com9Fragment : Fragment() {

    private lateinit var binding: FragmentCom9Binding
    ...
    override fun onCreateView(
       ...
       binding = FragmentCom9Binding.inflate(layoutInflater, container, false)
