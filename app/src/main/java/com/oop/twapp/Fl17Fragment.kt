...
import com.oop.twapp.databinding.FragmentFl17Binding


class Fl17Fragment : Fragment() {

    private lateinit var binding: FragmentFl17Binding
    ...
    override fun onCreateView(
        ...
        binding = FragmentFl17Binding.inflate(inflater, container, false)
