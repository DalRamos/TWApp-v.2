...
import com.oop.twapp.databinding.FragmentMa36Binding


class Ma36Fragment : Fragment() {

    private lateinit var binding: FragmentMa36Binding
    ...
    override fun onCreateView(
        ...
        binding = FragmentMa36Binding.inflate(inflater, container, false)
