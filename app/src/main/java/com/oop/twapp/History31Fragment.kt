...
class History31Fragment : Fragment() {

    private lateinit var binding: FragmentHistory31Binding
    ...
    override fun onCreateView(
        ...
        binding = FragmentHistory31Binding.inflate(inflater, container, false)
