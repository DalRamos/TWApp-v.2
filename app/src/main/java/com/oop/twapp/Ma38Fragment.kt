...
import com.oop.twapp.databinding.FragmentMa38Binding


class Ma38Fragment : Fragment() {

    private lateinit var binding: FragmentMa38Binding
    ...
    override fun onCreateView(
        ...
        binding = FragmentMa38Binding.inflate(inflater, container, false)
