...
import com.oop.twapp.databinding.FragmentMa34Binding


class Ma34Fragment : Fragment() {

    private lateinit var binding: FragmentMa34Binding
    ...
    override fun onCreateView(
        ...
        binding = FragmentMa34Binding.inflate(inflater, container, false)
