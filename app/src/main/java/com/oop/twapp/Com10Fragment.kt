...
import com.oop.twapp.databinding.FragmentCom10Binding

class Com10Fragment : Fragment() {

    private lateinit var binding: FragmentCom10Binding
    ...
    override fun onCreateView(
       ...
       binding = FragmentCom10Binding.inflate(layoutInflater, container, false)
